...
import { FileUpload } from "./FileUpload"; // import your OCR component

interface AddInventoryFormProps {
  switchToOCR?: () => void; // optional callback if parent wants to handle switching
}
...
export const AddInventoryForm = ({ switchToOCR }: AddInventoryFormProps) => {
  ...
  const [showOCR, setShowOCR] = useState(false); // NEW: toggle OCR view
    ...
    <Card className="glass-card p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          onClick={() => {
            setShowOCR(true);
            if (switchToOCR) switchToOCR(); // optional callback
          }}
